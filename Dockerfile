# based on cdrx/docker-pyinstaller:python3-32bit
...
RUN set -x \
    ...
    && wget -nc -P /etc/apt/sources.list.d/ https://dl.winehq.org/wine-builds/ubuntu/dists/$OS_CODENAME/winehq-$OS_CODENAME.sources \
